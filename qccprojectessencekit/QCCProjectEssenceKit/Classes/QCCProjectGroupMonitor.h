//
//  QCCProjectGroupMonitor.h
//

#import <Foundation/Foundation.h>

// The block to execute if a monitored folder changes
typedef void (^QCCProjectGroupMonitorBlock) (void);
...
@interface QCCProjectGroupMonitor : NSObject
...
/**
 Creates a new QCCProjectGroupMonitor to watch the folder at the given URL. Whenever there is a change on this folder the block is executed.
